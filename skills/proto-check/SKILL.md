---
name: proto-check
description: Use when the user has approved using this skill to inspect HTML prototypes before product review, including 原型自查, 原型走查, 规范检查, 易用性检查, 设计自查, 原型体检, 整改要求, 整改清单, or proto check.
---
...
3. `整改要求-YYYYMMDD-Codex.md` —— 汇总两份报告的 ❌/⚠️ 项,可直接粘贴
